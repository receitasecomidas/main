...
- 42 g water
- 1 g salt
- 1.2 g baked soda or powdered kansui (If using powdered kansui, use 0.7g potassium carbonate and 0.5 g sodium carbonate)
...
2. In a standing mixer with a paddle attachment, add your flour, Turn the mixer to "stir" and run for 30 seconds to aerate the mix.
...
8. Pull out your dough. Portion into workable sizes, and roll out to desired thickness using the pasta machine, using potato or cornstarch as you go to prevent sticking. In this case, around 2 mm thick.
9. Grab a sheet around 12 inches long, and cut into noodles approximately 3 mm wide, with a cutter.
...
11. Bundle the noodles into 180 g portions and place them in a sealable bag. Put the bag in the fridge and allow it to rest for at least a day.
